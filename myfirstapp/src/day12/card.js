...
function Cards(props){
    ...
    <Card style={{ width: '18rem' , color:'blue', borderRadius:'30px',backgroundColor:'black', color:"white"}}>
      ...
      <Card.Footer className="text-muted"> <Button variant="primary">Buy Now !</Button></Card.Footer>
    </Card>
